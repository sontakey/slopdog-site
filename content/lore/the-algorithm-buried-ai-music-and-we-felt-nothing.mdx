...
faq:
  - q: "Did Spotify remove AI music from recommendations?"
    a: "Spotify has not confirmed a policy change, but multiple AI artists reported algorithmic streams from Discover Weekly and Radio collapsing in spring 2026, around the same time Believe-owned TuneCore began blocking Suno tracks and Spotify piloted Verified badges. Deezer has openly confirmed it keeps AI-generated songs out of its recommendation algorithm."
