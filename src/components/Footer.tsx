    ...
    <footer className="border-t border-white/10 bg-black">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-3">
        <div className="space-y-3">
          ...
          <p className="text-label text-zinc-500">© {new Date().getFullYear()} SLOPDOG</p>
        </div>

        <div className="space-y-3">
          <div className="text-label uppercase text-zinc-300">LINKS</div>
        ...
        <div className="space-y-3">
          <div className="text-label uppercase text-zinc-300">SIGNAL</div>
          <form className="flex gap-2">
            ...
            />
            <button className="rounded-md bg-primary px-4 py-2 font-display text-body-sm font-bold text-black hover:opacity-90">
              JOIN
            </button>
          </form>
