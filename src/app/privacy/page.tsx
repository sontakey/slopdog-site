...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <h1 className="font-display text-display-md mb-8">Privacy Policy</h1>
      <div className="space-y-6 text-neutral-300 leading-relaxed">
        <p><strong>Effective Date:</strong> March 22, 2026</p>

        <h2 className="text-xl font-semibold text-fg mt-8">1. Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">2. How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">3. Payment Processing</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">4. Analytics</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">5. Cookies</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">6. Third-Party Services</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">7. Data Retention</h2>
        ...
        <h2 className="text-xl font-semibold text-fg mt-8">8. Your Rights</h2>
